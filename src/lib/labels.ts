...
export const fieldStateLabels: Record<string, string> = { EMPTY:"待补充",USER_CONFIRMED:"已确认·用户填写",AI_PENDING:"待确认·材料提取",AI_CONFIRMED:"已确认·材料提取",USER_EDITED:"已确认·用户修改",UNABLE_TO_CONFIRM:"无法确认",CONFLICT:"需核对",CONFIRMED:"已确认·材料提取",PENDING:"待确认·材料提取",UNKNOWN:"无法确认",MODIFIED:"已确认·用户修改",DELETED:"已删除",MANUAL_REQUIRED:"待人工处理" };
export const evidenceSupportLabels: Record<string,string> = { DIRECT:"有直接证据",PARTIAL:"有部分证据",USER_STATEMENT:"仅用户陈述",NONE:"暂无证据",CONFLICT:"材料存在冲突" };
